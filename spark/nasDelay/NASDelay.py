...
def calculate_year_wise_nas_delay(data_source, output_uri):
    with SparkSession.builder.appName("Calculate Year Wise NAS Delay").getOrCreate() as spark:
        ...
        year_wise_nas_delay = spark.sql("""SELECT Year,
            AVG((CASE WHEN ArrDelay = 0 THEN 0 ELSE NASDelay / ArrDelay END) * 100) AS AvgNASDelay
...
if __name__ == "__main__":
    ...
    calculate_year_wise_nas_delay(args.data_source, args.output_uri)